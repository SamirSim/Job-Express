    ...
    public function run()
    {
    	...
    	DB::table('utilisateurs')->delete();
       	...
       	DB::table('demandes')->insert([ 
       		...
       		['titre' => "Cherche Déménagement", 'lieu' => "Ain Naadja, 16065, Alger", 'description' => "Bonjour, J'aurai besoin d'une aide pour un déménagement qui aura lieu le samedi 19 mai. Le déménagement se fera de Méru à St Crépin Ibouvillers. C'est un petit déménagement.", 'montant' => "2000 DA", 'categorie' => "Demenagement", 'idUser' => 1, 'datePub' => "2018-04-19", 'dateService' => "2018-05-19"],
       		['titre' => "Cherche Déménagement", 'lieu' => "Bab El Oued, 16008, Alger", 'description' => "Bonjour, je recherche une personne costaude pour 2 heures de déménagement le 14/05/2018", 'montant' => "3000 DA", 'categorie' => "Demenagement", 'idUser' => 2, 'datePub' => "2018-04-26", 'dateService' => "2018-05-14"],
       	]);
